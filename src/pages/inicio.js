        ...
        <div className="text-gray-600 sm:container sm:mx-auto font-body">
            <nav className="text-right">
                <div className="flex justify-between items-center">
                    <h1 className="font-bold uppercase p-4 border-gray-200">
                        <a href="/" className="text-red-500 text-xl font-bold">Pokedex</a>
                    </h1>
                </div>
            </nav>
            ...
            <div className="mt-4 grid grid-cols-2  md:grid-cols-3 gap-5 p-5 py-10 shadow-xl rounded-lg">
                <div className="overflow-hidden rounded-xl shadow-xl">
                    <a href="/#" className="bg-emerald-300 px-10 object-cover block py-7 sm:py-10 bg-bgpokebol bg-contain  bg-no-repeat bg-right-bottom">
                        <span className="text-gray-50 text-7x1 font-bold">Pokedex</span>
                    </a>
                </div>
                <div className="overflow-hidden rounded-xl shadow-xl">
                    <a href="/#" className=" bg-indigo-400 px-10 object-cover block py-7 sm:py-10 bg-bgpokebol bg-contain  bg-no-repeat bg-right-bottom">
                        <span className="text-gray-50 text-7x1 font-bold">Regiones</span>
                    </a>
                </div>
                <div className="overflow-hidden rounded-xl shadow-xl">
                    <a href="/#" className=" bg-red-400 px-10 object-cover block py-7 sm:py-10 bg-bgpokebol bg-contain  bg-no-repeat bg-right-bottom">
