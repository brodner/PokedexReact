  ...
  return (
    <form onSubmit={SearchPokemon}>
      <div className=' bg-white flex justify-center p-3 shadow-sm border border-gray-200 rounded-full'>
        ...
        <input
          type='search' name='' id='' placeholder='Buscar Pokemon, Id, Nombre ' x-model='q' className='w-full pl-4 text-sm text-gray-800 outline-none focus:outline-none bg-transparent'
